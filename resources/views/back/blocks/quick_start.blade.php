                            ...
                            <div class="input-group file-caption-main">
                                <div class="file-preview-frame">
                                    <div class="kv-file-content">
                                        <img src="{{$quick_start->for_example_field->link}}?{{$quick_start->for_example_field->cache_index}}"
                                             class="kv-preview-data file-preview-image"
                                             title="{{$quick_start->for_example_field->alt}}"
                                             alt="{{$quick_start->for_example_field->alt}}">
                                    </div>
                                    <div class="file-thumbnail-footer">
                                        <div class="file-footer-caption"
                                             title="{{$quick_start->for_example_field->alt}}">{{$quick_start->for_example_field->name_field}}
                                            <br><samp>(425.24 KB)</samp></div>
                                        <div class="file-actions">
                                            <input type="text" class="form-control alt-text" data-block="quick_start"
