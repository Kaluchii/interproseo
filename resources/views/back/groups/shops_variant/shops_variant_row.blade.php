<tr role="row" class="odd" data-id="{{$item->id_field}}">
    ...
    {{-- Название  --}}
    <td class="sorting_1">
        <a href="shops/{{$item->id_field}}" class="">{{$item->title_field}}</a>
    </td>
    ...
    {{-- Удаления  --}}
    <td>
        <button type="button" class="btn btn-block btn-primary group-remove-item" data-id="{{$item->id_field}}" data-block="shops_variant">Удалить</button>
    </td>
</tr>