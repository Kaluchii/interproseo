<div class="box">
    <div class="box-header with-border">
        ...
        <button type="submit" class="btn btn-primary pull-right remove-flat-item" data-id="{{$item->id_field}}"
                data-block="adv_on_check">Удалить</button>
    </div>
    <div class="box-body">
                        ...
                        <div class="input-group file-caption-main">
                            ...
                            <div class="file-preview-frame">
                                <div class="kv-file-content">
                                    <img src="{{$item->adv_field->link}}?{{$item->adv_field->cache_index}}" class="kv-preview-data file-preview-image" title="{{$item->adv_field->alt}}" alt="{{$item->adv_field->alt}}">
                                </div>
                                <div class="file-thumbnail-footer">
                                    <div class="file-footer-caption" title="{{$item->adv_field->alt}}">{{$item->adv_field->name_field}} <br><samp>(425.24 KB)</samp></div>
                                    <div class="file-actions">
                                        <input type="text" class="form-control alt-text" data-block="adv_on_check" data-type="images" data-id="{{$item->id_field}}" data-name="alt" value="{{$item->adv_field->alt}}">
